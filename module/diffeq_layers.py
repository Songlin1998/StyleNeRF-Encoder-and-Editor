...
class IgnoreLinear(nn.Module):
    def __init__(self, dim_in, dim_out, dim_c, extend_dim):
...
class ConcatSquashLinear(nn.Module):
    def __init__(self, dim_in, dim_out, dim_c, extend_dim):
        ...
        # print('dim_c',dim_c)
        self._layer = nn.Linear(dim_in, dim_out)
        self._hyper_bias = nn.Linear(extend_dim + dim_c, dim_out, bias=False)
        self._hyper_gate = nn.Linear(extend_dim + dim_c, dim_out)
