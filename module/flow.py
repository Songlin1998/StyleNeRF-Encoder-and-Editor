...
def build_model( input_dim, hidden_dims, context_dim, num_blocks, conditional,ws_dim):
    def build_cnf():
        diffeq = ODEnet(
...
def cnf(input_dim,dims,zdim,num_blocks,ws_dim):
    dims = tuple(map(int, dims.split("-")))
    # print('input_dim:',input_dim) # 512
    # print('dims:',dims) # (512, 512, 512, 512, 512)
    # print('zdim:',zdim) # 17
    # print('num_blocks:',num_blocks) # 1
    model = build_model(input_dim, dims, zdim, num_blocks, True,ws_dim).cuda()
