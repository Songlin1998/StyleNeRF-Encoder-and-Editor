...
from utils.models_utils import load_old_G, initialize_e4e_wplus, load_old_G_stylenerf, save_tuned_G
...
class Coach:
    ...
    def restart_training(self):
        ...
        # Initialize networks
        # self.G = load_old_G()
        self.G = load_old_G_stylenerf()
        self.G.requires_grad_(True)

        # self.original_G = load_old_G()
        self.original_G = load_old_G_stylenerf()
